...
class ADBManager_adj:
            ...
            for step, batch in enumerate(tqdm(self.train_dataloader, desc="Iteration")):
                ...
                with torch.set_grad_enabled(True):
                    ...
                    if adj:
                        ...
                        loss, self.delta = criterion_boundary(features, self.centroids, label_ids, w)
                    else:
    ...
    def exp_gama(self):
        ...
        g = torch.exp(-self.gama / self.num_batch)
        if 1 - g < 1e-5:
            self.use_labeled_data = False
        self.gama += 1
