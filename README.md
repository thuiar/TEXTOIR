...
| 09/2021 	| 🎆 🎆 New paper TEXTOIR demo in Open Intent Recognition have been released, which is the first integrated and visualized platform for text Open Intent Recognition. Read our paper [TEXTOIR: An Integrated and Visualized Platform for Text Open Intent Recognition](https://aclanthology.org/2021.acl-demo.20.pdf). Fork the [codes](https://github.com/thuiar/TEXTOIR-DEMO). 	|
